...
class Room(Model):
    def __init__(self, light=False, num_switches=2, min_interval=2, max_interval=10, seed=None):
        ...
        model_metrics = {
            ...
            "ticks with light on": 'ticks_with_light_on'
        }
    ...
    def step(self):
        ...
        if self.light.power == True:
            self.ticks_with_light_on += 1
...
if __name__ == "__main__":
    ...
    num_ticks = 50  # Number of ticks to simulate
